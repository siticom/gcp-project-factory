...
variable "defaults" {
  ...
  type = object({
    ...
    environment_private_dns_zone = string
    environment_public_dns_zone  = string
...
variable "public_dns_zones" {
  description = "DNS public zones to create as child of var.defaults.environment_dns_zone."
  type        = list(string)
  default     = []
}

variable "acme_dns_cnames" {
  description = "Set CNAMEs for internal ACME challenges to a public DNS zone."
