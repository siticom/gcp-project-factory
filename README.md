...
## Changes compared to upstream project

This project factory is derived from Google's [cloud-foundation-fabric](https://github.com/GoogleCloudPlatform/cloud-foundation-fabric/tree/master/blueprints/factories/project-factory) (v21.0.0).

Changes are:
- support for private and public DNS zones
  - allows setting CNAMEs for ACME certificate requests
